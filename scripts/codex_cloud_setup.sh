...
python3 --version
python3 -m py_compile scripts/validate_mobile_iphone_platform.py scripts/mobile_operator.py scripts/ashell_static_server.py scripts/repository_audit_report.py scripts/ashell_codex_chat.py scripts/ashell_production_env.py
...
required_files = ['index.html', 'styles.css', 'app.js', 'manifest.webmanifest', 'service-worker.js', 'README.md', 'AGENTS.md', 'docs/iphone-local-dev-setup.md', 'settings/mobile-production/environment.json']
